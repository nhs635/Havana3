...
void DeviceOptionTab::setControlsStatus()
{
...
void DeviceOptionTab::initializeHelicalScanning(bool toggled)
{
	if (toggled)
	{
...
//void DeviceOptionTab::setHelicalScanningControl(bool toggled)
//{
...
void DeviceOptionTab::initializeFlimSystem(bool toggled)
{
    if (toggled)
    {
...
bool DeviceOptionTab::connectFlimLaser(bool state)
{
//	if (state)
//	{
...
//void DeviceOptionTab::sendLaserCommand(char* command)
//{
//	if (m_pElforlightLaser)
...
//void DeviceOptionTab::setFlimControl(bool toggled)
//{
//	// Set FLIm Control
//	if (toggled)
//	{
...
//void DeviceOptionTab::adjustDecibelRange()
//{
//	if (m_pAxsunControl)
...
//void DeviceOptionTab::setAxsunControl(bool toggled)
//{
...
//void DeviceOptionTab::requestOctStatus()
//{
